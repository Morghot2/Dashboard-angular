...
import { Records } from 'src/app/mockRecords';
 ...
 */
export class RecordsTableDataSource extends DataSource<RECORD> {
  data: RECORD[] = Records;
   ...
   */
  private getPagedData(data: RECORD[]): RECORD[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  // private getSortedData(data: RECORD[]): RECORD[] {
